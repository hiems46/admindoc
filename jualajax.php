                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php 
                                    $getpj = mysqli_query($conn, "SELECT * FROM tb_sj sj,tb_pjn pj, tb_cus cs WHERE sj.idcus=cs.idcus AND sj.idsj=pj.idsj 
                                    ");
                                    $i=1;
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    ...
    <form action="" method="POST"
      <!-- Modal body -->
      <div class="modal-body">
       <input type="text" name="idsj" id="idsj" class="form-control mt-2" placeholder="Nomor Invoice" onkeyup="autofill()">
       <input type="date" name="tgl_kirim" id="tgl_kirim" class="form-control mt-2" placeholder="Tgl invoice">
       <input type="text" name="tgl_jtp" id="tgl_jtp" class="form-control mt-2" placeholder="Tgl Jatuh Tempo">
       <input type="text" name="jml_ekor" id="jml_ekor" class="form-control mt-2" placeholder="Quantity">
       <input type="text" name="harga" id="harga" class="form-control mt-2" placeholder="Harga">
    </div>
