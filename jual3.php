                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php 
                                    $getpj = mysqli_query($conn, "SELECT * FROM tb_sj s, tb_cus c WHERE s.idcus=c.idcus
                                    ");
                                    $i=1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a class="add" href="jualdetail.php?idjual=<?=$idsj;?>" target="blank" title="add"><i class="fa fa-pen-to-square"></i></a>
