    ...
    <!-- Modal body -->
                <div class="modal-body">
                    ...
                    <option selected value="<?=$idcus?>"><?=$nama_cus?>-<?=$cabang?></option>
                        ...
                        <input type="text" name="bns_ekor" class="form-control mt-2" placeholder="Bonus DOC" value="<?=$bns_ekor;?>" onFocus="startHit();" required>
                        <input type="text" name="jml_ekor" class="form-control mt-2" placeholder="Jumlah DOC" value="<?=$jml_ekor;?>" min="1" onFocus="startHit();" onBlur="stopHit();" required>
                        <input type="text" name="ttldoc"  class="form-control mt-2" placeholder="total" onchange="tryNumberFormat(this.form.thirdBox);" readonly>
